...
class SdbcVideoUploadController extends Controller
{
    public $route="sdbc_video";
    ...
    {        
        ...
        return view('admin/SdbcAdm/'.$this->view.'/index', compact('moduleName', 'BlzVideo')); 
    ...
    public function edit($id){
        ...
        return view('admin/SdbcAdm/'.$this->view.'/_form', compact('moduleName', 'BlzVideo'));
    }
