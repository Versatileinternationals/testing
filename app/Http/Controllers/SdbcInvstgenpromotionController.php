...
class SdbcInvstgenpromotionController extends Controller
{
    public $route="sdbc_what_we_do";
    ...
    {        
        ...
        return view('admin/SdbcAdm/'.$this->view.'/index', compact('moduleName', 'Blzgen_promotion'));
    }
    ...
    public function store(Request $request)
    {
       //echo 'fffffff'; die;
		...
		if ($request->hasFile('image')) {   
            $whtimage = $request->file('image');
            $imageName = uniqid() . '.' . $whtimage->getClientOriginalExtension();
            $destinationPath = public_path('/assets/images/upload');
            $whtimage->move($destinationPath, $imageName);         
    ...
    public function edit($id){
        ...
        return view('admin/SdbcAdm/'.$this->view.'/_form', compact('moduleName', 'Blzgen_promotion'));
    }
    ...
    {        
        ...
        return view('admin/SdbcAdm/'.$this->view.'/team_index', compact('moduleName', 'Blz_team_members'));
    }
	public function team_create()
    {
         $moduleName = 'Team Members'; 
        return view('admin/SdbcAdm/'.$this->view.'/team_form',compact('moduleName')); 
    }
    ...
    public function team_store(Request $request)
    {
       //echo 'fffffff'; die;
        ...
        //echo 'kkkkk'; die;
        return redirect('sdbc_team_members')->withStatus(__('Team Member is added successfully.'));
    }
    ...
    public function team_edit($id){
        ...
        return view('admin/SdbcAdm/'.$this->view.'/team_editform', compact('moduleName', 'Blzgen_promotion'));
    }
    ...
    public function team_update(Request $request,$id)
    {
      ...
      if ($request->hasFile('image')) {   
        ...
        return redirect('sdbc_team_members')->withStatus(__('Team Member updated successfully.'));
    }
    public function team_delete($id){
         $moduleName = 'Team Members'; 
        $Blzgen_promotion = Blz_team_member::find($id)->delete();
        return redirect('sdbc_team_members')->withStatus(__('Team Member is updated successfully.'));
    }
    ...
    {        
        ...
        return view('admin/SdbcAdm/'.$this->view.'/resources_index', compact('moduleName', 'Blz_Resources'));
    }
	public function resource_create()
    {
         $moduleName = 'Resources'; 
        return view('admin/SdbcAdm/'.$this->view.'/resources_form',compact('moduleName')); 
    }
    ...
    public function resource_store(Request $request)
    {
        ...
        //echo 'kkkkk'; die;
        return redirect('sdbc_resources')->withStatus(__('Resources Data is added successfully.'));
    }
    ...
    public function resource_edit($id){
        ...
        return view('admin/SdbcAdm/'.$this->view.'/resources_editform', compact('moduleName', 'Blzgen_Resources'));
    }
    ...
    public function resource_update(Request $request,$id)
    {
        ...
        return redirect('sdbc_resources')->withStatus(__('Resources Data updated successfully.'));
    }
    public function resource_delete($id){
         $moduleName = 'Resources'; 
        $Blzgen_promotion = Blz_resources::find($id)->delete();
        return redirect('sdbc_resources')->withStatus(__('Resources Data is updated successfully.'));
    }
