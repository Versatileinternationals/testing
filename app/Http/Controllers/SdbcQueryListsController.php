...
class SdbcQueryListsController extends Controller
{
    public $route="sdbc_query";
    ...
    {     
        ...
        return view('admin/SdbcAdm/'.$this->view.'/index', compact('moduleName', 'faq'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin/SdbcAdm/'.$this->view.'/_form', compact('moduleName', 'QueryLists'));
    }
