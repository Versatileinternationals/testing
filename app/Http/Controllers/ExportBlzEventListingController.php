...
class ExportBlzEventListingController extends Controller
{
    public $route="expblz_event";
    ...
    {        
        ...
        return view('admin/ExportBlz/'.$this->view.'/index', compact('moduleName', 'BlzEvent'));  
    }
    ...
    public function edit($id){
        ...
        return view('admin/ExportBlz/'.$this->view.'/_form', compact('moduleName', 'BlzEvent'));
    }
    ...
    {        
        ...
        //$trainings = Product::with(['category','subcategory','brandData'])->orderBy('id','DESC')->get();
         $BlzEvent = BlzEvent::where('status',1)->orderBy('id','DESC')->get();
        return view('admin/ExportBlz/'.$this->view.'/event_calender', compact('moduleName', 'BlzEvent'));  
    }
}
