...
class NewsletterController extends Controller
{
    ...
    {        
        ...
        $Newsletter = Newsletter::where('status',1)->orderBy('id','DESC')->get();  
        return view('admin/Admb2b/'.$this->view.'/index', compact('moduleName','Newsletter'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect($this->route)->withStatus(__('Newsletter is added successfully.'));
    }

    public function edit($id){
        $moduleName = $this->moduleName;  
         $Newsletter = Newsletter::find($id); 
        return view('admin/Admb2b/'.$this->view.'/_form', compact('moduleName', 'Newsletter'));
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        $Newsletter = Newsletter::find($id)->update([
            'links' => $request->links,
        ...
        return redirect($this->route)->withStatus(__('Newsletter is updated successfully.'));
    }

    public function delete($id){
        $moduleName = $this->moduleName;  
        $Newsletter = Newsletter::find($id)->delete();
        return redirect($this->route)->withStatus(__('Newsletter is Delete successfully.'));
    }
