...
class BlzInvstBusinessRcsController extends Controller
{
    public $route="blzinvst_business_resources";
    ...
    {        
        ...
        return view('admin/BlzInvest/'.$this->view.'/index', compact('moduleName', 'BlzBusinessResources'));  
    }
    ...
    public function edit($id){
        ...
        return view('admin/BlzInvest/'.$this->view.'/_form', compact('moduleName', 'BlzRes'));
    }
