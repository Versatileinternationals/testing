...
{
    public $route="productmanagement";
    public $view ="ProductManagement";
    public $moduleName = 'Product Management';

    public function index()
    {        
        $moduleName = $this->moduleName;                
        //$trainings = Product::with(['category','subcategory','brandData'])->orderBy('id','DESC')->get();  
        return view('admin/Admb2b/'.$this->view.'/index', compact('moduleName'));
    }
