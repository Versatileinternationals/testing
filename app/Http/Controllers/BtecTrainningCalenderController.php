...
class BtecTrainningCalenderController extends Controller
{
    ...
    {     
        ...
        $TrainningCal = BlzTrainee::orderBy('id','DESC')->get();  
        return view('admin/BlzInvest/'.$this->view.'/index', compact('moduleName', 'TrainningCal'));
    }
