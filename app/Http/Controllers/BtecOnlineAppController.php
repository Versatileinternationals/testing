...
class BtecOnlineAppController extends Controller
{
    ...
    public function edit($id){
        ...
        return view('admin/BlzInvest/'.$this->view.'/_form', compact('moduleName', 'product','category', 'products','subcategory', 'brand' ));
    }
