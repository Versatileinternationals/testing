...
class SdbcAdvRqstController extends Controller
{
    public $route="sdbc_advisory";
    public $view ="AdvRqst";
    ...
    {     
        ...
        return view('admin/SdbcAdm/'.$this->view.'/index', compact('moduleName', 'BlzAdvisoryRequests'));	
    ...
    public function edit($id){
        ...
        return view('admin/SdbcAdm/'.$this->view.'/_form', compact('moduleName', 'BlzAdvisoryRequests'));
    }
