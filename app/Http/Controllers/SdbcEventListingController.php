...
class SdbcEventListingController extends Controller
{
    public $route="sdbc_event";
    ...
    {        
        ...
        return view('admin/SdbcAdm/'.$this->view.'/index', compact('moduleName', 'BlzEvent'));  
    }
    ...
    {        
        ...
        //$trainings = Product::with(['category','subcategory','brandData'])->orderBy('id','DESC')->get();
         $BlzEvent = BlzEvent::where('status',1)->orderBy('id','DESC')->get();
        return view('admin/SdbcAdm/'.$this->view.'/event_calender', compact('moduleName', 'BlzEvent'));  
    }
    ...
    public function edit($id){
        ...
        return view('admin/SdbcAdm/'.$this->view.'/_form', compact('moduleName', 'BlzEvent'));
    }
