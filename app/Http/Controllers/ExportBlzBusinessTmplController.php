...
class ExportBlzBusinessTmplController extends Controller
{
    public $route="expblz_businesstmpl";
    ...
    {        
        ...
        return view('admin/ExportBlz/'.$this->view.'/index', compact('moduleName', 'BlzBusinessTemplates'));  
    }
    ...
    public function edit($id){
        ...
        return view('admin/ExportBlz/'.$this->view.'/_form', compact('moduleName', 'BlzBusinessTemplates'));
    }
