...
{
    public $route="buyer_account";
    public $view ="buyer_account";
    public $moduleName = 'Buyer Account';

    public function index()
    {        
	
        $moduleName = $this->moduleName;                
        $BuyerAccounts = Buyer::where('user_type','buyer')->orderBy('id','DESC')->get(); 
        return view('admin/Admb2b/'.$this->view.'/index', compact('moduleName','BuyerAccounts'));
    }
