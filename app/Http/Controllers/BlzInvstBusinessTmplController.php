...
class BlzInvstBusinessTmplController extends Controller
{
    public $route="blzinvst_businesstmpl";
    public $view ="BusinessTmpl";
    public $moduleName = 'Manage Resources';
    ...
    {        
        ...
        return view('admin/BlzInvest/'.$this->view.'/index', compact('moduleName', 'BlzBusinessTemplates'));  
    }
    ...
    public function edit($id){
        ...
        return view('admin/BlzInvest/'.$this->view.'/_form', compact('moduleName', 'BlzBusinessTemplates'));
    }
