...
class BtecTrainingController extends Controller
{
    ...
    {        
        ...
        //$trainings = BlzTraining::with(['category','subcategory','brandData'])->orderBy('id','DESC')->get();  
    ...
    public function edit($id){
      ...
      // print_r($BlzTrainingin); die;
        return view('admin/BlzInvest/'.$this->view.'/_form', compact('moduleName', 'BlzTrainingin'));
    }
