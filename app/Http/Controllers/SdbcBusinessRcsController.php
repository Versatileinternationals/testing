...
class SdbcBusinessRcsController extends Controller
{
    public $route="sdbc_business_resources";
    ...
    {        
        ...
        return view('admin/SdbcAdm/'.$this->view.'/index', compact('moduleName', 'BlzBusinessResources'));  
    }
    ...
    public function edit($id){
        ...
        return view('admin/SdbcAdm/'.$this->view.'/_form', compact('moduleName', 'BlzRes'));
    }
