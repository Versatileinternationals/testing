...
class SdbcOnlineAppController extends Controller
{
    public $route="sdbc_application";
    ...
    {        
        ...
        return view('admin/SdbcAdm/'.$this->view.'/index', compact('moduleName','BlzApp'));
    }
    ...
    public function edit($id){
        ...
        return view('admin/SdbcAdm/'.$this->view.'/_form', compact('moduleName', 'user'));
    }
    ...
    public function view($id){
        ...
        return view('admin/SdbcAdm/'.$this->view.'/view', compact('moduleName', 'product'));
    }
