...
class ExportBlzVideoUploadController extends Controller
{
    public $route="expblz_video";
    ...
    {        
        ...
        return view('admin/ExportBlz/'.$this->view.'/index', compact('moduleName', 'BlzVideo')); 
    ...
    public function edit($id){
        ...
        return view('admin/ExportBlz/'.$this->view.'/_form', compact('moduleName', 'BlzVideo'));
    }
