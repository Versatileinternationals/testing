...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <div class="card-body">
              <form method="post" action="{{url('clienttestimonials')}}" class="form theme-form">
                @csrf
                <div class="row">
                  <div class="col-6">
                  ...
                  <div class="col-6">
                    <div class="form-group mb-3">
                      ...
                      <input class="form-control" type="text" value="{{old('description')}}" name="description" placeholder="Description" >
                      @error('description')
                      <div class="text-danger show"><strong>{{$message}}</strong></div>
                      @enderror
                    </div>
