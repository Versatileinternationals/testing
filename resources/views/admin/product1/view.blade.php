      ...
      <div class="col-xl-5 xl-100 box-col-6">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-4">
                <h6 class="product-title">Purchase Note</h6>
              </div>
              <div class="col-md-8">
                <div class="product-icon">
                  <ul class="product-social">
                    <li class="d-inline-block">{{$product->purchase_note =="" ?  "-" : $product->purchase_note}}</li>                   
                  </ul>                  
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="product-icon">
                  <ul class="product-social">
                    <li class="d-inline-block">{{$product->page_keyword =="" ?  "-" : $product->page_keyword}}</li>                   
                  </ul>                
                </div>
              </div>
            </div>
