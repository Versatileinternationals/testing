...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <div class="card-body">
              <form method="post" action="{{url('btec_events')}}" class="form theme-form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-6">
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="form-group mb-3">
                      ...
                      <input class="form-control" type="text" value="{{old('EventType')}}" name="EventType" placeholder="Enter Event Type">                      
                      @error('EventType')
                      <div class="text-danger show"><strong>{{$message}}</strong></div>
                      @enderror
                    </div>
