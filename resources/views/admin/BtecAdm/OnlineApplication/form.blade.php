...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <div class="card-body">
              <form method="post" action="{{url('online_application')}}" class="form theme-form">
                @csrf
                <div class="row">
                  <div class="col-6">
                ...
                <div class="row">
                  <div class="col-12">
                    <div>
                      ...
                      <a href="{{url('online_application')}}"><button type="button" class="btn btn-danger">Cancel</button></a>
                    </div>
                  </div>
                </div>
              </form>
