...
<div class="container-fluid">
   ...
   <div class="row second-chart-list third-news-update">
     ...
     <div class="col-lg-8 dashboard-sec box-col-12">
           ...
           <div class="row m-0">
             <div class="col-lg-3 earning-content p-0">
               <div class="row m-0 chart-left">
                 ...
                 <div class="col-lg-12 p-0 left_side_earning">
                   <h5>123456 </h5>
                   <p class="font-roboto">This Month Visitors</p>
                 </div>
                 <div class="col-lg-12 p-0 left_side_earning">
                   <h5>12345</h5>
                   <p class="font-roboto">New Account Creted </p>
                 </div>
                 <div class="col-lg-12 p-0 left_side_earning">
                   <h5>100</h5>
           ...
           <div class="row m-0 chart-main">
             ...
             <div class="col-lg-4 col-md-6 col-sm-6 p-0 box-col-6">
               <div class="media align-items-center">
                 ...
                 <div class="media-body">
                   <div class="right-chart-content">
                     <h4>1005</h4><span>Pending Accounts</span>
                   </div>
                 </div>
               </div>
             </div>
             <div class="col-lg-4 col-md-6 col-sm-6 p-0 box-col-6">
               <div class="media align-items-center">
                 ...
                 <div class="media-body">
                   <div class="right-chart-content">
                     <h4>1006</h4><span>New Proudct Listing</span>
                   </div>
                 </div>
               </div>
             </div>
             <div class="col-lg-4 col-md-6 col-sm-6 p-0 box-col-6">
               <div class="media border-none align-items-center">
                 ...
                 <div class="media-body">
                   <div class="right-chart-content">
                     <h4>101</h4><span>Active Jobs</span>
                   </div>
                 </div>
               </div>
             </div>
   ...
   <div class="row">
    <div class="col-lg-4 xl-50 box-col-12">
      <div class="card">
            ...
            <div class="table-responsive">
              <table class="table table-bordernone">
                <tbody class="f-w-500">
                  <tr>
                    <td>
                      <div class="media"><img class="img-fluid m-r-15 rounded-circle" src="{{asset('assets/images/dashboard-2/product-1.png')}}" alt="">
                        <div class="media-body"><span>Hike Shoes</span>
                          <p class="font-roboto">100 item</p>
                        </div>
                      </div>
                    </td>
                    <td> <p>coupon code</p><span>PIX001</span></td>
                    <td><p>-51%</p><span>BD99.00</span></td>
                  </tr>
                  <tr>
                    <td>
                      <div class="media"><img class="img-fluid m-r-15 rounded-circle" src="{{asset('assets/images/dashboard-2/product-3.png')}}" alt="">
                        <div class="media-body"><span>Tree Pot</span>
                          <p class="font-roboto">105 item</p>
                        </div>
                      </div>
                    </td>
                    <td><p>coupon code</p><span>PIX002</span></td>
                    <td><p>-78%</p><span>BD66.00</span></td>
                  </tr>
                  <tr>
                    <td>
                      <div class="media"><img class="img-fluid m-r-15 rounded-circle" src="{{asset('assets/images/dashboard-2/product-4.png')}}" alt="">
                        <div class="media-body"><span>Bag</span>
                          <p class="font-roboto">604 item</p>
                        </div>
                      </div>
                    </td>
                    <td><p>coupon code</p><span>PIX003</span></td>
                    <td><p>-04%</p><span>BD116.00</span></td>
                  </tr>
                  <tr>
                    <td>
                      <div class="media"><img class="img-fluid m-r-15 rounded-circle" src="{{asset('assets/images/dashboard-2/product-5.png')}}" alt="">
                        <div class="media-body"><span>Wtach</span>
                          <p class="font-roboto">541 item</p>
                        </div>
                      </div>
                    </td>
                    <td><p>coupon code</p><span>PIX004</span></td>
                    <td><p>-60%</p><span>BD99.00</span></td>
                  </tr>
                  <tr>
                    <td>
                      <div class="media"><img class="img-fluid m-r-15 rounded-circle" src="{{asset('assets/images/dashboard-2/product-6.png')}}" alt="">
                        <div class="media-body"><span>T-shirt</span>
                          <p class="font-roboto">999 item</p>
                        </div>
                      </div>
                    </td>
                    <td><p>coupon code</p><span>PIX005</span></td>
                    <td><p>-50%</p><span>BD58.00</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
