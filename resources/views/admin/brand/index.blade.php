           ...
           <div class="card-header">          
               <div class="row">
                  ...
                  <div class="col-6 text-right">
                     ...
                     <a href="{{url('brand/create')}}"><button class="btn btn-primary"><i class="fa fa-plus mr-1"></i>New</button></a>
                     @endpermission
                  </div>
               </div>             
           </div>
                     ...
                     <tr>
                        ...
                        <td>
                            @permission('edit.brand')
                                <a href='{{url('brand/'.encrypt($value->id))}}' class='btn btn-primary btn-sm'> <i class="fa fa-edit"></i></a>
                            @endpermission
                        </td>
                     </tr>
                     @endforeach
