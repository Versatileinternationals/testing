...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <div class="card-body">
              <form method="post" action="{{url('sdbc_what_we_do/'.$Blzgen_promotion->id)}}" class="form theme-form"  enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
					 ...
					 <img width="200px" src="{{ asset('assets/images/upload') . '/' . $Blzgen_promotion->image }}" alt="" class="image">
                  </div>
                  <div class="col-6">
