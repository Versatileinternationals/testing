...
@section('title', 'Final Assessment List')
...
<h3>Final Assessment List</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item active">Final Assessment List</li>
@endsection
...
<script>
    ...
    $.ajax({
      type: "GET",
      url: "/blzinvst_final_assesment_data",
      dataType: "json",
      success: function(data) {
          console.log(data);
        if (data.status == 200) {
...
//   <button class="btn btn-primary btn-sm" id="Edit" value="' + item.id + '">Edit</button>\
 ...
 $.ajaxSetup({
      ...
      $.ajax({
         type:"POST",
         url:"/blzinvst_final_delete/"+delete_id,
         success:function(data)
         {
           if(data.status == 200)
           {
