...
@section('title', 'Pre-Assessment List')
...
<h3>Pre-Assessment List</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item active">Pre-Assessment List</li>
@endsection
...
//   <button class="btn btn-primary btn-sm" id="Edit" value="' + item.id + '">Edit</button>\
 ...
 $.ajaxSetup({
      ...
      $.ajax({
         type:"POST",
         url:"/blzinvst_pre_delete/"+delete_id,
         success:function(data)
         {
           if(data.status == 200)
           {
