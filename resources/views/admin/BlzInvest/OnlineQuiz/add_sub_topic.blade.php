    ...
    <div class="row">
        <div class="col-sm-12">
          <div class="card">
           ...
           <div class="card-body">
               <form method="post" action="{{url('blzinvst_add_subtopic/')}}" id="sub_topic_form1" class="form theme-form">
			    @csrf
                  <input type="hidden" name="training_id" id="training_id" value="{{$trenid->id}}">
                
                <div class="row" id="AddSub">
                    <div class="col-8">
                    <div class="form-group">
                                <label for="exampleInputPassword1">Sub Topic Name</label>
                                <input type="text" class="form-control" id="subtop_name" name="subtop_name">
								@error('subtop_name')
                              ...
                              <div class="col-4">
                               <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary me-3" style="margin-top: 30px;">Add</button>
                              </div>
