    ...
    <div class="row">
        <div class="col-sm-12">
          <div class="card">
           ...
           <div class="card-body">
               <form method="post" action="{{url('blzinvst_update_subtopic/'.$trenid->id)}}" id="sub_topic_form1" class="form theme-form">
			    @csrf
                ...
                <div class="row" id="AddSub">
                    ...
                    <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="top_name" name="top_name" value="{{$trenid->top_name}}">
								@error('subtop_name')
