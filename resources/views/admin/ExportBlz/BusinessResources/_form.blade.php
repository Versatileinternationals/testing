...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <div class="card-body">
              <form method="post" action="{{url('expblz_business_resources/'.$BlzRes->id)}}" class="form theme-form">
                @csrf
                ...
                <div class="row">      
                  <div class="col-6">
					 ...
					 <div class="form-group mb-3">
                      ...
                      <input class="form-control" type="file"  name="document_upload" >
                ...
                <div class="row">
                  <div class="col-12">
                    <div>
                      ...
                      <a href="{{url('expblz_business_resources')}}"><button type="button" class="btn btn-danger">Cancel</button></a>
                    </div>
                  </div>
                </div>
              </form>
