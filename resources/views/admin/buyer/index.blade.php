           ...
           <div class="card-header">          
               <div class="row">
                  ...
                  <div class="col-6 text-right">
                     ...
                     <a href="{{url('users/buyer/create')}}"><button class="btn btn-primary"><i class="fa fa-plus mr-1"></i>New</button></a>
                     @endpermission
                  </div>
               </div>             
           </div>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href='{{url('users/'.encrypt($value->id))}}' class='btn btn-primary btn-sm'> <i class="fa fa-edit"></i></a>
                           @endpermission
                        </td>
                     </tr>
                     @endforeach
