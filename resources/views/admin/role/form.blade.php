                ...
                <div class="form-group">
                  <label class="col-form-label" for="name">Permissions :</label>
                    <div class="col-lg-12 permission-card">
                      @php $cntt = 1;$cnn = 1; @endphp
                      @foreach(array_chunk($modules, 3) as $threepermission)
                        @if($cntt%3 == 1)
                          <div class="row">
                        @endif
                          <div class="col-lg-4 permission-listing">                              
                              ...
                              <div class="form-check checkbox checkbox-primary mb-0">
                                <input class="form-check-input permission" type="checkbox"  id="customCheckboxx{{$cnn}}" name="modulepermission[]" value="{{ $module }}">
                                <label class="custom-control-label permision-label" for="customCheckboxx{{$cnn}}">{{ $module }}</label>
                              </div>
                              @php $cnn++; @endphp
                              @endforeach
                          </div>
