            ...
            <li class="sidebar-list">
			   ...
			   <li><a class="submenu-title" href="#">Trainings<div class="according-menu"><i class="fa fa-angle-right"></i></div></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          ...
                          <li><a class="lan-5" href="{{url('blzinvst_training')}}">Add New Training</a></li>
					      @endif
					       @if(App\Models\ModulePermission::where('role_id',12)->where('module_id',86)->first() == null || Auth::user()->role_id==1) 
                ...
                <li><a class="submenu-title" href="#">Jobs<div class="according-menu"><i class="fa fa-angle-right"></i></div></a>
                 ...
                 <li><a class="lan-5" href="{{url('blzinvst_businesstmpl')}}">Business Templates</a></li>
			      @endif 
			      @if(App\Models\ModulePermission::where('role_id',12)->where('module_id',94)->first() == null || Auth::user()->role_id==1)
                 <li><a class="lan-5" href="{{url('blzinvst_business_resources')}}">Business Resource Guide</a></li>
			      @endif 
           ...
           <li class="sidebar-list">
			   ...
			   <li><a class="submenu-title" href="#">Trainings<div class="according-menu"><i class="fa fa-angle-right"></i></div></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          ...
                          <li><a class="lan-5" href="{{url('sdbc_self_paced')}}">Add New Training</a></li>
           ...
           <li class="sidebar-list">
			   ...
			   <li><a class="submenu-title" href="#">Trainings<div class="according-menu"><i class="fa fa-angle-right"></i></div></a>
                        <ul class="nav-sub-childmenu submenu-content">
                          ...
                          <li><a class="lan-5" href="{{url('expblz_training')}}">Add New Training</a></li>
