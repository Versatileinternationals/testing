                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-body">
                        ...
                        <form id="kt_account_profile_details_form" class="form"
                            action="{{ url('/investor/create-concept') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="text" name="feed_id" value="{{$feedback->id}}">
                            <div style="font-size:24px; margin-bottom:10px;" class="row text-center"><b>Contact
                                    Information</b></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group mb-2">
                                    <input type="radio" name="LeadPoint" value="Disagree">    
                                    <label class="col-form-label">Disagree</label>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group mb-2">
                                    <input type="radio" name="LeadPoint" value="Neither">    
                                    <label class="col-form-label">Neither</label>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group mb-2">
                                    <input type="radio" name="LeadPoint" value="Agree">    
                                    <label class="col-form-label">Agree</label>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group mb-2">
                                    <input type="radio" name="LeadPoint" value="Strongly agree">    
                                    <label class="col-form-label">Strongly agree</label>
                                    </div>
                                </div>
                            </div>
