                            ...
                            <div class="d-flex align-items-start flex-wrap">
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fs-2 fw-bolder mb-1">{{$member->name}} {{$member->last_name}}</div>
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    <form id="kt_account_profile_details_form" class="form" action="{{ url($member->user_type.'/profile') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label fw-bold fs-6">@if($member->user_type =='trainee') Logo @else Profile Image @endif</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
                                    <!--begin::Image input-->
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{url('assets/images/user/default.png')}}');">
                                        <!--begin::Preview existing avatar-->
                                        @if($member->image!='')
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{url('assets/images/upload/'.$member->image)}}');"></div>
                                        @else
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{url('assets/images/user/default.png')}}');"></div>
                                        @endif
                           ...
                           <div class="row mb-6">
                            ...
                            <hr>
                             ...
                             <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
									...
									<option value="">Select Eduction Level</option>
									
									<option value="1"{{old('education_level',$sellerData->education_level) ==1? 'selected' : ''}}>Primary School</option>
									<option value="2"{{old('education_level',$sellerData->education_level) ==2? 'selected' : ''}}>High School</option>
									<option value="3"{{old('education_level',$sellerData->education_level) ==3? 'selected' : ''}}>Associate's Degree</option>
									<option value="4"{{old('education_level',$sellerData->education_level) ==4? 'selected' : ''}}>Bachelor's Degree</option>
							...
							<div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label fw-bold fs-6">
                                    <span class="required">Current Employment Status</span>
                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Website Link"></i>
                                </label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
									...
									<option value="">Select Eduction Level</option>
									<option value="1"{{old('employment_status',$sellerData->employment_status) ==1? 'selected' : ''}}>Yes</option>
									<option value="2"{{old('employment_status',$sellerData->employment_status) ==2? 'selected' : ''}}>No</option>
