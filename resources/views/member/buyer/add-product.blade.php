            ...
            <div class="flex-md-row-fluid ms-lg-12">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <!--error msg -->
                        <form id="kt_account_profile_details_form" class="form" action="{{ url('member/add-product') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                              <div class="col-6">
                            ...
                            <div class="row">      
                                <div class="col-lg-6">
                                  <div class="form-group mb-3">
                                    ...
                                    <select class="js-example-basic-single select2 col-sm-12 form-select" name="category_id" id="category_id" onchange="getSubcategory(this.value)">                                                  
                            ...
                            <div class="row">
                                <div class="col-6">
                                  <div class="form-group">
                                      ...
                                      <input class="form-control" type="date" value="{{old('sale_start_date')}}" name="sale_start_date" placeholder="Sale Start Date">
                                ...
                                <div class="col-6">
                                  <div class="form-group">
                                      ...
                                      <input class="form-control" type="date" value="{{old('sale_end_date')}}" name="sale_end_date" placeholder="Sale End Date">
                                      @error('sale_end_date')
                                      <div class="text-danger show"><strong>{{$message}}</strong></div>
                                      @enderror
                                  </div>
                            ...
                            <div class="row">
                              <div class="col-6">  
                                ...
                                <div class="form-group">                       
                                    <input class="form-control" type="color" value="{{old('colors')}}" name="colors" placeholder="Available Colors">
                                </div>
                              </div>
                              <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-12">
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="purchase_note" value="{{old('purchase_note')}}" placeholder="Purchase Note">
                                      @error('purchase_note')
                                      <div class="text-danger show"><strong>{{$message}}</strong></div>
                                      @enderror
                                  </div>
                            ...
                            <div class="row">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="m-t-15 m-checkbox-inline custom-radio-ml">
                                        <div class="form-check form-check-inline radio radio-primary">
                                          <input class="form-check-input" id="free" type="radio" checked name="shipping_class" value="free">
                                          <label class="form-check-label mb-0" for="free">Free</label>
                                        </div>
                                        <div class="form-check form-check-inline radio radio-primary">
                                          <input class="form-check-input" id="charge" type="radio" name="shipping_class" value="charge">
                                ...
                                <div class="col-6">
                                  <div class="form-group">
                                      ...
                                      <div class="m-t-15 m-checkbox-inline custom-radio-ml">
                                        <div class="form-check form-check-inline radio radio-primary">
                                          <input class="form-check-input" id="add_to_cart" type="radio" checked name="button_text" value="Add to Cart">
                                          <label class="form-check-label mb-0" for="add_to_cart">Add to Cart</label>
                                        </div>
                                        <div class="form-check form-check-inline radio radio-primary">
                                          <input class="form-check-input" id="call_for_price" type="radio" name="button_text" value="Call For Price">
                            ...
                            <div class="row">
                                <div class="col-6">
                                  <div class="form-group">
                                      ...
                                      <input class="form-control" type="text" value="{{old('page_title')}}" name="page_title" placeholder="Page Title">
                                      @error('page_title')
                                      <div class="text-danger show"><strong>{{$message}}</strong></div>
                                      @enderror
                                  </div>
                                ...
                                <div class="col-6">
                                  <div class="form-group">
                                      ...
                                      <input class="form-control inputtags" type="text" value="{{old('page_keywords')}}" name="page_keywords" placeholder="Page Meta Keyword">
                                      @error('page_keywords')
                                      <div class="text-danger show"><strong>{{$message}}</strong></div>
                                      @enderror
                                  </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                  <div class="form-group">
                                      ...
                                      <textarea class="form-control" name="page_description" placeholder="Page Description">{{old('page_description')}}</textarea>
                            ...
                            <div class="row specification-div">
                              <div class="col-lg-5">
                                <div class="form-group">
                                  <input class="form-control" type="text" value="" name="key[]" placeholder="Title">
                                </div>
                              
                              </div> 
                              <div class="col-lg-5">
                                <div class="form-group">
                                  <input class="form-control"  type="text" value="" name="value[]" placeholder="Value">
                                </div>
                              </div>
                              <div class="col-lg-2">
                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                <div class="form-group mb-3">
                                  ...
                                  <select class="js-example-basic-single select2 col-sm-12 form-select" multiple name="related_product[]" id="related_product" placeholder="Select Product">                                                  
                                    @foreach ($products as $value)
                                    <option value="{{$value->id}}" {{in_array($value->id,old('related_product',[])) ==true? 'selected' : ''}}>{{$value->sku}}</option>    
                                    @endforeach
                                  </select>  
                                ...
                                <div class="form-group mb-3">
                                  <div class="media mb-2">
                                    ...
                                    <div class="media-body text-right icon-state">
                                      <label class="switch">
                                        <input type="checkbox" name="allow_customer_review" value="1" checked="">
                                  ...
                                  <div class="media mb-2">
                                    ...
                                    <div class="media-body text-right icon-state">
                                      <label class="switch">
                                        <input type="checkbox" name="sold_avaliable" value="1" checked="">
                                        <span class="switch-state"></span>
                                      </label>
                                    </div>
                                  </div>
                                  <div class="media mb-2">
                                    ...
                                    <div class="media-body text-right icon-state">
                                      <label class="switch">
                                        <input type="checkbox" name="allow_return" value="1" checked="">
                                        <span class="switch-state"></span>
                                      </label>
                                    </div>
                                  </div>
