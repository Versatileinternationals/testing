                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Add SubCategory</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
					...
					@if(session()->has('message'))
                        ...
                        @endif
                        <!--error msg -->
                        <form id="kt_account_profile_details_form" class="form" action="{{ url('seller/subcategory') }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
<div class="row">
                  <div class="col-12">
                            ...
                            <div class="row">
                              <div class="col-12">
                                <div>
                                  ...
                                  <a href="{{url('seller/category')}}"><button type="button" class="btn btn-danger">Cancel</button></a>
                                </div>
                              </div>
                            </div>
