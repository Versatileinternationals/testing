        ...
        <div class="d-flex flex-column flex-lg-row">
            ...
            <div class="flex-md-row-fluid">
                ...
                <div class="card mb-5 mb-xl-10">
					...
					<div class="col-md-3"><a style="float:right" a href="{{url('seller/category/create')}}"  class="btn btn-success me-2 mb-2"><i class="fa fa-add" aria-hidden="true"></i> Add Category</a></div>
					</div>
                    <!--begin::Card header-->
                    <!--begin::Content-->
                    <div class="card-body">
