            ...
            <div class="flex-md-row-fluid ms-lg-12">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <!--error msg -->
                        <form id="kt_account_profile_details_form" class="form" action="{{ url('seller/edit-testimonial/'.$ClientTestimonials->id) }}" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                             <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                        <label class="col-form-label">Clinet Name</label>
                        <input class="form-control" type="text" value="{{old('name',$ClientTestimonials->name)}}" name="name" placeholder="Clinet Name">
                        @error('name')
                            ...
                            <div class="row">      
                              <div class="col-lg-12">
                                <div class="form-group">
                                  ...
                                  <textarea class="ckeditor form-control" id="description" name="description" cols="30" rows="10" required>{{old('description',$ClientTestimonials->description)}}
                                  </textarea>
                                  @error('description')
                                  <div class="text-danger show"><strong>{{$message}}</strong></div>
                                  @enderror
