							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="stepper stepper-links d-flex flex-column pt-15" id="kt_create_account_stepper">
										...
										<!--end::Nav-->
										<!--begin::Form-->
										<form  class="mx-auto mw-600px w-100 pt-15 pb-10" method="post"novalidate="novalidate" id="kt_create_account_form">
											<!--begin::Step 1-->
											@csrf
											<div class="current" data-kt-stepper-element="content" id="account_type">
												<!--begin::Wrapper-->
												<div class="w-100">
													<!--begin::Heading-->
											...
											<!--end::Step 1-->
											<!--begin::Step 2-->
											<div data-kt-stepper-element="content" id="account_info">
												<!--begin::Wrapper-->
												<div class="w-100">
													<!--begin::Heading-->
													<div class="pb-10 pb-lg-15">
														...
														<div class="row mb-2" data-kt-buttons="true">
															...
															<div class="col">
																...
																<label class="btn btn-outline btn-outline-dashed btn-outline-default w-100 p-4">
																	<input type="radio" class="btn-check size account_team_size" name="account_team_size" value="1-1">
															...
															<div class="col">
																...
																<label class="btn btn-outline btn-outline-dashed btn-outline-default w-100 p-4 active">
																	<input type="radio" class="btn-check size account_team_size" name="account_team_size" checked="checked" value="2-10">
															...
															<div class="col">
																<!--begin::Option-->
																<label class="btn btn-outline btn-outline-dashed btn-outline-default w-100 p-4">
																	<input type="radio" class="btn-check size account_team_size" name="account_team_size" value="10-50">
															...
															<div class="col">
																<!--begin::Option-->
																<label class="btn btn-outline btn-outline-dashed btn-outline-default w-100 p-4">
																	<input type="radio" class="btn-check size account_team_size" name="account_team_size" value="50+">
													...
													<div class="mb-10 fv-row">
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" class="form-control form-control-lg form-control-solid account_name" name="account_name" placeholder="" value="">
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
											...
											<!--end::Step 2-->
											<!--begin::Step 3-->
											<div data-kt-stepper-element="content" id="business_info">
												<!--begin::Wrapper-->
												<div class="w-100">
													<!--begin::Heading-->
													...
													<div class="fv-row mb-10">
														...
														<!--end::Label-->
														<!--begin::Input-->
														<input name="business_name" id="business_name" class="form-control form-control-lg business_name form-control-solid" value="">
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
													...
													<div class="fv-row mb-10">
														...
														<!--end::Label-->
														<!--begin::Input-->
														<select name="business_type" class="form-select form-select-lg form-select-solid select2-hidden-accessible" data-control="select2" data-placeholder="Select..." data-allow-clear="true" data-hide-search="true" data-select2-id="select2-data-10-5kbq" tabindex="-1" aria-hidden="true">
															<option data-select2-id="select2-data-12-w7mk"></option>
														...
														</select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-11-4bt8" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-lg form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-business_type-hx-container" aria-controls="select2-business_type-hx-container"><span class="select2-selection__rendered" id="select2-business_type-hx-container" role="textbox" aria-readonly="true" title="Select..."><span class="select2-selection__placeholder">Select...</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
														<!--end::Input-->
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
											...
											<!--end::Step 3-->
											<!--begin::Step 4-->
											<div data-kt-stepper-element="content" id="Billing_details">
												<!--begin::Wrapper-->
												<div class="w-100">
													<!--begin::Heading-->
													<div class="pb-10 pb-lg-15">
													...
													<div class="d-flex flex-column mb-7 fv-row">
														...
														<!--end::Label-->
														<input type="text" class="form-control form-control-solid card_name" placeholder="" name="card_name" value="Max Doe">
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
													<div class="d-flex flex-column mb-7 fv-row">
													...
													<div class="row mb-10">
														...
														<div class="col-md-8 fv-row">
															...
															<div class="row fv-row">
																<!--begin::Col-->
																<div class="col-6">
																	<select name="card_expiry_month" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Month" data-select2-id="select2-data-13-d8en" tabindex="-1" aria-hidden="true">
																		<option data-select2-id="select2-data-15-jd2t"></option>
																	...
																	</select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-14-wxlb" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-card_expiry_month-fa-container" aria-controls="select2-card_expiry_month-fa-container"><span class="select2-selection__rendered" id="select2-card_expiry_month-fa-container" role="textbox" aria-readonly="true" title="Month"><span class="select2-selection__placeholder">Month</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
																</div>
																<!--end::Col-->
																<!--begin::Col-->
																<div class="col-6">
																	<select name="card_expiry_year" class="form-select form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true" data-placeholder="Year" data-select2-id="select2-data-16-buhp" tabindex="-1" aria-hidden="true">
																		<option data-select2-id="select2-data-18-onbd"></option>
																	...
																	</select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-17-easo" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-card_expiry_year-93-container" aria-controls="select2-card_expiry_year-93-container"><span class="select2-selection__rendered" id="select2-card_expiry_year-93-container" role="textbox" aria-readonly="true" title="Year"><span class="select2-selection__placeholder">Year</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
																</div>
																<!--end::Col-->
															</div>
															<!--end::Row-->
											...
											<!--end::Step 4-->
											<!--begin::Step 5-->
											<div data-kt-stepper-element="content" id="completed">
												<!--begin::Wrapper-->
												<div class="w-100">
													<!--begin::Heading-->
											...
											<div class="d-flex flex-stack pt-15">
												...
												<!--begin::Wrapper-->
												<div>
													<button type="submit"  id="submitBtn" class="btn btn-lg btn-primary me-3" data-kt-stepper-action="submit">
													...
													<button type="button" class="btn btn-lg btn-primary" id="nextBtn" data-kt-stepper-action="next">Continue 
													<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
...
<script>
    $(document).on("click","#nextBtn",function()
    {
        if($(".btn-check").val())
        {
          $("#account_type").removeClass("current");
          $("#account_info").addClass("current");
        }
       if($(".account_name").val())
        {
           $("#account_info").removeClass("current");
           $("#business_info").addClass("current"); 
        }
       if($(".business_name").val())
        {
           $("#business_info").removeClass("current");
          $("#Billing_details").addClass("current"); 
          $("#nextBtn").hide();
          $("#submitBtn").show();
    ...
    headers: {
      ...
      $.ajax({
                type:"POST",
                url:"/investor/profile-create_do",
                data:$("form").serialize(),
