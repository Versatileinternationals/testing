                        ...
                        <div class="rowFormFields">
                            <div class="column1">
                                <select class="form-select" name="search">
                                   <option value="all">All Belize</option>
                            ...
                            <div class="column2">
                                <input type="text" class="typeahead form-control" placeholder="Enter Your Search..."/>
                            </div>
                            <div class="column3">
                    ...
                    <div class="col-md-4">
                        <div class="boxBusinessHub">
                            ...
                            <div class="contentBusinessHub">
                                ...
                                <p class="text-center"><a href="{{ url('seller-profile/MTE=') }}" class="btn">Contact Company</a></p>
                            </div>
                        </div>
                    </div>
                    @endforeach
