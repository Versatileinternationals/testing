...
@section('content')
    ...
    <article>
                ...
                <div class="row rowInvestmentContent align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="boxSelectCource">
                            <h2>Select Course </h2>
                            <form action="{{url('active-training')}}" method="POST">
							@csrf
        ...
        <div class="sectionTopTraining">
            <div class="container">
                <h2 class="text-center mb-4 text-white">Instructor Led Training </h2>
				
                <div class="row">
                    @foreach($ActiveTraining as $SelfPacedList)
                    ...
                    <div class="col-md-6">
                        <div class="boxPaidTrainings">
							...
							<?php   $timestamp = strtotime($SelfPacedList->TrainingStartDate);
								...
								<span><a href="{{url('training-registration/'.base64_encode($SelfPacedList->id))}}" class="btn btn-secondary">  Join Here </a></span>
